...
const handleRepoCommand = async (m, Matrix) => {
  const repoUrl = 'https://api.github.com/repos/Nethaking/NethuMax-MD';
  try {
              ...
              buttons: [
                ...
                },
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://github.com/Nethaking/NethuMax-MD/fork`
                  })
                },
                {
                  name: "cta_url",
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://whatsapp.com/channel/0029Vaj1q0OJJhzd66LuCz2O`
                  })
                }
              ],
            }),
